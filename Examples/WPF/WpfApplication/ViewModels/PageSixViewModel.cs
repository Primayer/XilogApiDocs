...
{
    class PageSixViewModel : WorkspaceViewModel
    {
        public string Token
        {
            get
        ...
        {
            var request = WebRequest.Create(string.Format("https://decode.primayer.com/api/xilog/getsites?token={0}", Token));
