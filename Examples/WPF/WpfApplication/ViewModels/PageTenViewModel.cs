...
namespace WpfApplication.ViewModels
{
    class PageTenViewModel : WorkspaceViewModel
    {
        ...
        {
            var request = WebRequest.Create(string.Format("http://decode.primayer.com/api/xilog/getdatatounits?siteID={0}&channelID={1}&token={2}&startDate={3}&endDate={4}&units={5}", Logger, Channel, Token, StartDate.ToString("MM/dd/yyyy"), EndDate.ToString("MM/dd/yyyy"), Units));
