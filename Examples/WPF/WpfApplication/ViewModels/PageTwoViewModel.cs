...
{
    class PageTwoViewModel : WorkspaceViewModel
    {
        ...
        {
            var request = WebRequest.Create(string.Format("https://decode.primayer.com/api/xilog/getHeader?siteID={0}&channelID={1}&token={2}", Logger, Channel, Token));
