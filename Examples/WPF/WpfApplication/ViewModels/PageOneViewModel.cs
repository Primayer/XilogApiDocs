...
{
    class PageOneViewModel: WorkspaceViewModel
    {
        ...
        {
            var request = WebRequest.Create(string.Format("https://decode.primayer.com/api/xilog/getdata?siteID={0}&channelID={1}&token={2}&startDate={3}&endDate={4}&timeWindowStart&timeWindowEnd",Logger, Channel, Token, StartDate.ToString("MM/dd/yyyy"), EndDate.ToString("MM/dd/yyyy")));
